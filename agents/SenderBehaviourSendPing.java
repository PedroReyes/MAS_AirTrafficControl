...
import bootstrap.MessageManager;
...
class SenderBehaviourSendPing extends OneShotBehaviour {
    ...
    /**
     * this is the method that defines what the behaviour does it initiates a
     * conversation with agent a2 by sending it the message "Ping" with the
     * conversation id "mesaj"
     */
    public void action() {
