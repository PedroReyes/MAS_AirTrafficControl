...
public class Avion extends Agent {
	...
	public void actualizarInformacion(String content) {
		...
		case "MOD":
			...
			Vector aux = new Vector(Integer.parseInt(vector[0].substring(9)), Integer.parseInt(vector[1].substring(2)),
					0);
	...
	public void mandarMensaje(String orden) {
		...
		msg.setContent(getTimeStep() + " " + orden + " " + getID() + " " + getPosicionActual() + " "
				+ getCombustibleActual() + " " + getCombustibleXStep());
	...
	public String toString() {
		return "Avion: [" + getID() + "," + getVectorDirector() + "," + getPosicionActual() + ","
				+ getCombustibleActual() + "," + getCombustibleXStep() + "," + getTimeStep() + "]\n";
	}
